...
export const DeliveryLoop = () => {
  return (
    <section id="delivery" className="relative overflow-hidden bg-ink/35 py-24">
          ...
          {steps.map((step, index) => {
            ...
            return (
              <motion.div
                ...
                className="min-h-[250px] border border-white/10 bg-surface/70 p-6 transition hover:border-cyan/35 hover:bg-surfaceLight/70"
              >
                ...
                <h3 className="mb-5 text-2xl font-bold">{step.title}</h3>
