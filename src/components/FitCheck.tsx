...
export const FitCheck = () => {
  return (
    <section id="fit-check" className="relative overflow-hidden py-24">
        ...
        <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <div className="grid gap-5">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="border border-white/10 bg-surface/70 p-6"
            >
              ...
              <div className="grid gap-3 md:grid-cols-5">
                {questions.map((question, index) => (
                  <div key={question} className="min-h-[132px] border border-white/10 bg-background/65 p-4">
                    <div className="mb-4 font-display text-2xl font-bold text-gold">{String(index + 1).padStart(2, '0')}</div>
              ...
              {outcomes.map((item, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`border p-5 ${item.tone}`}
                  >
